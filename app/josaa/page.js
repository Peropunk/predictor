...
export default function JOSAAredictor() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isFormValid) {
      console.log({ rank, domicile, category, seatType, isPwD });
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100 p-4">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mt-4">
        ...
        {/* PwD Selection Buttons */}
        <div className="mb-4">
          <p className="text-gray-900 mb-2">Are you PwD? (optional)</p>
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => setIsPwD("Yes")}
              className={`flex-1 px-4 py-2 rounded-lg ${
                isPwD === "Yes" 
                  ? "bg-blue-600 text-white" 
                  : "bg-gray-200 text-gray-800"
