...
const counselorData = [
  ...
  { name: "CSAB", logo: "CSAB.webp", link: "/csab" },
  { name: "JAC DELHI", logo: "JAC-Delhi.png", link: "/jac" },
  { name: "UPTAC", logo: "upsee.jpg", link: "/upsee" },
  { name: "WBJEE", logo: "wbjee.png", link: "/college-a" },
  { name: "IPU", logo: "ipu.png", link: "/ipu" },
...
<div className="bg-white p-4 rounded-lg shadow-md lg:max-w-4xl mx-auto">
    ...
    <Link href="/">
  <div className="relative p-4 bg-blue-600 text-white rounded-lg shadow-md text-center font-semibold cursor-pointer transition-transform duration-300 hover:scale-105 
    before:absolute before:inset-0 before:-z-10 before:blur-lg before:rounded-lg 
    after:absolute after:left-1/2 after:-translate-x-1/2 after:-bottom-2 after:w-[70%] after:h-[4px] after:bg-blue-700 after:rounded-full after:content-['']">
    Undergraduate Courses
      ...
      <Link href="/pg">
        <div className="p-4 bg-sky-400 text-white rounded-lg shadow-md text-center font-semibold cursor-pointer transition-transform duration-300 hover:scale-105">
